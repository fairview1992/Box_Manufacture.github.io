...
if($result->num_rows > 0)
{
	...
	{
		echo"<tr>"; 
		echo"<td><center>".$row["id_Feed"]. "</center></td>";
		echo"<td><center>".$row["name_Feed"]. "</center></td>";
		echo"<td><center>".$row["feedback_Feed"]. "</center></td>";
		echo"<td><center>".$row["feedback_grade"]."</center></td>";
	?>

	<td align="center"><a href="Admindeletefeedback.php?id=<?php echo $row["id_Feed"]; ?>">
