...
<div class="navbar">
	...
	<br></br>
		<h1><center>ADMIN DETAIL</center></h1>
		<center>
<table class="mama" >
	<tr>
		<th>ID User</th>
...
$sql="SELECT id_Emp,name_Emp,user_Emp,email_Emp FROM employee";
...
if($result->num_rows > 0)
{
	...
	{
		echo"<tr>"; 
		echo"<td><center>".$row["id_Emp"]. "</center></td>";
		echo"<td><center>".$row["name_Emp"]. "</center></td>";
		echo"<td><center>".$row["user_Emp"]. "</center></td>";
		echo"<td><center>".$row["email_Emp"]."</center></td>";
	?>

	<td align="center"><a href="adminListDelete.php?id=<?php echo $row["id_Emp"]; ?>">
