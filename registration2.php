...
<center><h4>Mrs. Janet Ng Lay Ngor</h4></center>
<center>
  
<button class="button button1" input type="submit" value="submit"onclick="myFunction()"><a href="https://api.whatsapp.com/send?phone=+60162013630">Send Message</a>
</button>
</center>
<br>
...
<ol>
	<button class="button button1" type="submit" value="submit"onclick="myFunction()">Submit</button>
